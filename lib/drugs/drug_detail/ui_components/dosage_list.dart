    ...
    return 
                      ReorderableListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Container(
                            key: ValueKey(dosages[index].hashCode), // Unique key for the entire row
                            ...
                            margin: const EdgeInsets.symmetric(vertical: 4), // Optional margin between items
                            child: Row(
                              children: [
                                if (editMode)
                                ...
                                Expanded(
                                  child: DosageSnippet(
                                    key: ValueKey(dosages[index].hashCode), // Use DosageSnippet key
                                    editMode: editMode,
                                    onDosageDeleted: () {
