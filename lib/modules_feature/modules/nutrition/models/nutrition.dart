...
abstract class Nutrition {
  ...
  Nutrition({required this.source});
  ...
  Nutrition createNewNutrition(Source source) {
    return switch (source) {
      ContinousSource c => Continuous(continuousSource: c, mlPerHour: 0),
      IntermittentSource i => Intermittent(intermittentSource: i, quantity: 1),
    };
  }
}
