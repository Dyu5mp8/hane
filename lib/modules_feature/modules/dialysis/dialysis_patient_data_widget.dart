...
class DialysisPatientDataWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String weightText = (vm.weight > 0)
        ? vm.weight.toStringAsFixed(0)
        : 'N/A';
    ...
    final String idealWeightText = (vm.idealWeight() > 0)
        ...
        : 'N/A';
    final String hematocritText = (vm.hematocritLevel > 0)
    ...
    return GestureDetector(
      onTap: () {
        _showEditDialog(context, vm, weightText, lengthText, idealWeightText, hematocritText);
      },
      child: Container(
  ...
  void _showEditDialog(
    ...
    final TextEditingController hematocritController =
        TextEditingController(text: hematocritText != 'N/A' ? hematocritText : '');
    ...
    void saveForm() {
      if (_formKey.currentState?.validate() ?? false) {
        ...
        final double newHematocrit = double.parse(hematocritController.text.trim());
