              ...
              return SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Vikt (kg): ${model.weight.toStringAsFixed(1)}'),
                    Slider(
                      min: 40.0,
                      max: 150.0,
                    ...
                    Text('Hematokritnivå: ${(model.hematocritLevel * 100).toStringAsFixed(1)}%'),
                    Slider(
                      min: 0.20,
                      max: 0.60,
                    ...
                    SizedBox(height: 5),
                    // Citrate Level Input
                    Text('Citratnivå: ${model.citrateLevel.toStringAsFixed(1)}'),
                    Slider(
                      min: 1.0,
                      max: 4.0,
                      divisions: 6,
                    ...
                    SizedBox(height: 5),
                    // Blood Flow Input
                    Text('Blodflöde (ml/min): ${model.bloodFlow.toStringAsFixed(1)}'),
                    Slider(
                      min: 50.0,
                      max: 300.0,
                    ...
                    Text('Predilutionsflöde (ml/h): ${model.preDilutionFlow.toStringAsFixed(1)}'),
                    Slider(
                      min: 500.0,
                      max: 3000.0,
                      value: model.preDilutionFlow.clamp(500.0, 5000.0),
                      onChanged: (value) {
                    ...
                    SizedBox(height: 5),
                    // Fluid Removal Input
                    Text('Vätskeborttag (ml/h): ${model.fluidRemoval.toStringAsFixed(1)}'),
                    Slider(
                      min: 0.0,
                      max: 500.0,
                      value: model.fluidRemoval.clamp(0.0, 5000.0),
                      onChanged: (value) {
                    ...
                    Text('Dialysatflöde (ml/h): ${model.dialysateFlow.toStringAsFixed(1)}'),
                    Slider(
                      min: 500.0,
                      max: 3000.0,
                    ...
                    Text('Postdilutionsflöde (ml/h): ${model.postDilutionFlow.toStringAsFixed(1)}'),
                    Slider(
                      min: 500.0,
                      max: 5000.0,
