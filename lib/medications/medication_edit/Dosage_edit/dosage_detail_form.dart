...
TextEditingController lowerLimitDoseAmountController = TextEditingController();
TextEditingController lowerLimitDoseUnitController = TextEditingController();

TextEditingController higherLimitDoseAmountController = TextEditingController();
...
String? validateDosageFields(String ? value){
  ...
  bool isValidDose = val.validateAmountInput(doseAmount) == null && val.validateUnitInput(doseUnit)==null;
...
void saveDosage(){
  var instruction = instructionController.text == "" ? null : instructionController.text;
  var administrationRoute = administrationRouteController.text == "" ? null : administrationRouteController.text;
  var dose = createDose(doseAmountController.text, doseUnitController.text);
  var lowerLimitDose = createDose(lowerLimitDoseAmountController.text, lowerLimitDoseUnitController.text);
  var higherLimitDose = createDose(higherLimitDoseAmountController.text, higherLimitDoseUnitController.text);
  var maxDose = createDose(maxDoseamountController.text, maxDoseUnitController.text);
