...
final ThemeData appTheme = ThemeData(
  ...
  textTheme: TextTheme(
    ...
    // ···
    titleLarge: GoogleFonts.barlowSemiCondensed(fontSize: 30),
    bodyMedium: GoogleFonts.rubik(fontSize: 12),
    displaySmall: GoogleFonts.rubik(fontSize: 10),

    headlineLarge: GoogleFonts.rubik(fontSize: 20),

    bodyLarge: GoogleFonts.rubik(fontSize: 16),

    headlineSmall: GoogleFonts.rubik(fontSize: 14),

    bodySmall: GoogleFonts.rubik(fontSize: 12),

    headlineMedium: GoogleFonts.rubik(fontSize: 16),
  ),
  ...
  snackBarTheme: SnackBarThemeData(
    ...
    elevation: 8,
    contentTextStyle: GoogleFonts.rubik(fontSize: 12, color: Colors.black),
  ),
  chipTheme: ChipThemeData(
    backgroundColor: const Color.fromARGB(255, 255, 228, 220),
    labelStyle: GoogleFonts.rubik(fontSize: 12, color: Colors.black),
    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
  ),

  badgeTheme: BadgeThemeData(
    backgroundColor: const Color.fromARGB(255, 181, 71, 16),
    textStyle: GoogleFonts.rubik(fontSize: 12, color: Colors.black),
  ),
